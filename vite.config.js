...
const backend = process.env.VITE_BACKEND_URL || (process.env.PORT ? `http://localhost:${process.env.PORT}` : 'http://localhost:8000');
const proxyPaths = ['/timers', '/add-timer', '/meta-events', '/api', '/auth', '/test', '/health', '/callback'];
